...
class cTkLanguageManagerBase(Structure):
    ...
    # char *__fastcall sub_14262C940(__int64 a1, char *a2, char a3)
    @function_hook(signature="48 89 5C 24 10 57 48 81 EC 20 01 00 00 33", offset=0x262C940)
...
class cGcProductData(Structure):
    ...
    _Description: Annotated[bytes, Field(ctypes.c_char_p, offset=0x100)]  # ("macDescription", common.cTkDynamicString),
    BaseValue: Annotated[int, Field(ctypes.c_int32, offset=0x174)]  # ("miBaseValue", ctypes.c_int32),
    _NameLower: Annotated[nms_basic_types.cTkFixedString, Field(nms_basic_types.cTkFixedString[0x80], offset=0x24C)]  # ("macNameLower", common.cTkFixedString[0x80]),
...
class cGcRealityManager(Structure):
    ...
    # __int64 __fastcall sub_140D61800(__int64 a1)
    @function_hook(signature="48 8B C4 48 89 48 08 55 53 56 57 41 54 41 56", offset=0x0D61800)
    def Construct(self, this: "ctypes._Pointer[cGcRealityManager]") -> ctypes.c_uint64:
        pass

    # __int64 __fastcall sub_140D6E420(__int64 a1, __int64 a2, char *a3)
    @function_hook(signature="48 89 5C 24 08 45 0F", offset=0x0D6E420)
    ...
    # __int64 __fastcall sub_140D6F0B0(_QWORD *a1, __m128i *a2)
    @function_hook(signature="48 89 54 24 10 48 89 4C 24 08 55 53 41 54 48", offset=0x0D6F0B0)
    ...
    # __int64 __fastcall sub_140D72AD0(__int64 a1, __int128 *a2, char a3)
    @function_hook(signature="44 88 44 24 18 48 89 4C 24 08 55 41", offset=0x0D72AD0)
