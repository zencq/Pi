...
class cGcStatsTypes(Structure):
    # offsets can be taken from https://github.com/monkeyman192/MBINCompiler/blob/v4.12.1-pre1/libMBIN/Source/NMS/GameComponents/GcStatsTypes.cs#L4
...
class cGcStatsBonus(Structure):
    # offsets can be taken from https://github.com/monkeyman192/MBINCompiler/blob/v4.12.1-pre1/libMBIN/Source/NMS/GameComponents/GcStatsBonus.cs#L6
    Stat: Annotated[cGcStatsTypes, Field(cGcStatsTypes, offset=0x0)]  # ("mStat", cGcStatsTypes),
    Bonus: Annotated[float, Field(ctypes.c_float, offset=0x4)]  # ("mfBonus", ctypes.c_float),
    Level: Annotated[int, Field(ctypes.c_int32, offset=0x8)]  # ("miLevel", ctypes.c_int32),
