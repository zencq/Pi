...
# as seen here https://github.com/monkeyman192/MBINCompiler/blob/v6.02.1-pre1/libMBIN/Source/NMS/GameComponents/GcStatsTypes.cs#L7
class eStatsType(IntEnum):
    ...
    Ship_Drift = auto()
    Ship_Inventory = auto()
    Ship_Tech_Slots = auto()
    Ship_Cargo_Slots = auto()
    Ship_Teleport = auto()
