...
class cTkLanguageManagerBase(Structure):
    ...
    # search for "LANGUAGE\\%s_%s.MBIN" around the latest offset 0x23653E0
...
class cGcProductData(Structure):
    ...
    Description: Annotated[str, Field(nms_basic_types.cTkDynamicArray[ctypes.c_char], offset=0xF8)]
    BaseValue: Annotated[int, Field(ctypes.c_int32, offset=0x16C)]
    NameLower: Annotated[str, Field(nms_basic_types.cTkFixedString[0x80], offset=0x238)]
...
class cGcRealityManager(Structure):
    ...
    # search for "Metadata/Simulation/Missions/Tables/MissionTable.mXml" around the latest offset 0x0D14080
    @function_hook(signature="48 89 4C 24 08 55 53 56 57 41 54 41 56 41 57 48 8D AC 24 E0")
